    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_created', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('time_updated', models.DateTimeField(auto_now=True, verbose_name='Date de mise à jour')),
                ('name', models.CharField(max_length=255, verbose_name='Nom de la série')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ISBN', models.CharField(blank=True, max_length=13, null=True, validators=[django.core.validators.MinLengthValidator(10)], verbose_name='ISBN')),
                ...
                ('cover_ID', models.CharField(blank=True, max_length=20, null=True, verbose_name='ID de couverture')),
                ('artist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='my_library.artist', verbose_name='Artiste')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='my_library.author', verbose_name='Auteur')),
                ('publisher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='my_library.publisher', verbose_name='Editeur')),
                ('serie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='my_library.serie', verbose_name='Série')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_created', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('time_updated', models.DateTimeField(auto_now=True, verbose_name='Date de mise à jour')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book', to='my_library.book', verbose_name='Livre')),
        ...
        migrations.AddIndex(
            model_name='book',
            index=models.Index(fields=['book_type'], name='my_library__book_ty_1e7995_idx'),
        ),
        migrations.AddIndex(
            model_name='book',
            index=models.Index(fields=['title'], name='my_library__title_917927_idx'),
        ),
