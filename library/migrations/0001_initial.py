# Generated by Django 5.2 on 2025-09-09 21:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='library.artist', verbose_name='Artiste')),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='library.author', verbose_name='Auteur')),
                ('publisher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='library.publisher', verbose_name='Editeur')),
                ('serie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='books', to='library.serie', verbose_name='Série')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_created', models.DateTimeField(auto_now_add=True, verbose_name='Date de création')),
                ('time_updated', models.DateTimeField(auto_now=True, verbose_name='Date de mise à jour')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book', to='library.book', verbose_name='Livre')),
        ...
        migrations.AddIndex(
            model_name='book',
            index=models.Index(fields=['book_type'], name='library_boo_book_ty_a79c11_idx'),
        ),
        migrations.AddIndex(
            model_name='book',
